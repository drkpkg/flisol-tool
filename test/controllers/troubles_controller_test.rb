...
class TroublesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trouble" do
    assert_difference('Trouble.count') do
      post troubles_url, params: { trouble: { description: @trouble.description, name: @trouble.name } }
    end
  ...
  test "should update trouble" do
    patch trouble_url(@trouble), params: { trouble: { description: @trouble.description, name: @trouble.name } }
