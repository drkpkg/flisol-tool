...
class DistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distro" do
    assert_difference('Distro.count') do
      post distros_url, params: { distro: { description: @distro.description, name: @distro.name, package_id: @distro.package_id, version: @distro.version } }
    end
  ...
  test "should update distro" do
    patch distro_url(@distro), params: { distro: { description: @distro.description, name: @distro.name, package_id: @distro.package_id, version: @distro.version } }
